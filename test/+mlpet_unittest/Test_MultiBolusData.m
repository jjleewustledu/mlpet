	...
	methods (Test)
 	...
 	methods (TestMethodSetup)
		function setupMultiBolusDataTest(this)
 			import mlpet.*;
 			this.testObj = MultiBolusData( ...
                'activity', exp(-(0:99)/33), ...
                'times', 100:199, ...
                'dt', 0.5, ...
                'datetimeMeasured', datetime('1-Jan-2017 09:00:00', 'TimeZone', 'America/Chicago'), ...
