classdef (Abstract) IDeviceKit < handle & matlab.mixin.Heterogeneous & matlab.mixin.Copyable
	%% IDEVICEKIT provides the interface for the abstract factory pattern comprising mlpet.DeviceKit, 
    %  its concrete subclasses, mlpet.AbstractDevice and its concrete subclasses.
