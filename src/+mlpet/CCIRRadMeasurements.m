classdef CCIRRadMeasurements < handle & dynamicprops & mldata.Xlsx & mlpet.RadMeasurements
    ...
    properties
        tableNames = { ...
            'capracHeader' ...
            'countsFdg' 'countsOcOo' 'tracerAdmin' 'countsFdgVenous' ...
        ...
        sheetNames = { ...
            ...
            'Radiation Counts Log - Runs' 'Radiation Counts Log - Runs-1' 'Radiation Counts Log - Runs-2' 'Radiation Counts Log - Runs-2' ...
        ...
        datetimeTypes = { ...
            'exceldatenum' ...
            'exceldatenum' 'exceldatenum' 'exceldatenum' 'datetime' ...
            ...
            for t = 1:length(this.tableNames)
                try
                    ...
                    switch this.tableNames{t} % manage document variations
                        ...
                        case 'countsFdgVenous' % anomaly after 20210421
                            if ~any(contains(T.Properties.VariableNames, "DECAYCorrSpecificActivity_KBq_mL"))
                                T = this.readtable(fqfn, 'Radiation Counts Log - Runs-2', 1, 1, 'datetime');
                            end
                        otherwise
                    end
