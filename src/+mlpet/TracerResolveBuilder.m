...
%             end
        ...
        function this = motionCorrectCTAndUmap(this)
            ...
            if (~isempty(this.sessionData_.motionCorrectCTAndUmapConfig))
                this.refreshTracerResolvedFinalSumt(sessFdg);
                this.refreshTracerResolvedFinalSumt(sessHo);
                theImages = [product ... 
                             this.sessionData_.motionCorrectCTAndUmapConfig.theImages ...
                             this.umapSynthFp];
                cRB_ = mlfourdfp.CompositeT4ResolveBuilder( ...
                    'sessionData', this.sessionData_, ...
                    'theImages', theImages, ...
                    'maskForImages', ['Msktgen' this.sessionData_.motionCorrectCTAndUmapConfig.maskForImages 'none'], ...
